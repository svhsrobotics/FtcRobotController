...
public class PowerPlayBot2 extends Robot {

    static final double REV_COUNTS = 28;
    static final double GEAR_REDUCTION = 40;
    static final double WHEEL_DIAMETER = 3;

    public Grabber2 grabber2;

    public PowerPlayBot2(HardwareMap hardwareMap, Logger logger) {
        super(hardwareMap, logger);
    }

    public PowerPlayBot2(HardwareMap hardwareMap) {
        super(hardwareMap);
    }
    ...
    protected void initGrabber() {
        grabber2 = new Grabber2(
                hardwareMap.get(DcMotor.class, "topmotor"),
                hardwareMap.get(DcMotor.class, "middlemotor"),
                hardwareMap.get(DcMotor.class, "bottommotor"),
                hardwareMap.get(DcMotor.class, "hslide"),
